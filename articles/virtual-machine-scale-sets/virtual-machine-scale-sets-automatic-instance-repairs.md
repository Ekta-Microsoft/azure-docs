...
> **NOTE** 
> Install the Application Health Extension on your VMSS before following the below steps.
...
9. Turn **On** the **Automatic repairs** option.
10. In **Grace period (min)**, specify the grace period in minutes, allowed values are between 30 and 90 minutes.
11. When you're done, select **Save**.
